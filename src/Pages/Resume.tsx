...
import resume from "../assets/images/resume_thomas_crowe.jpg";

function Resume(): React.ReactElement {
    return (
        <div className="resume-container flex-col justify-center align-center m-auto mt-10">
            <h1 className="text-white m-10 header">Resume</h1>
            {/* put a link to download the resume pdf here */}
            <a className='text-white text-3xl m-10' href="./assets/resume_thomas_crowe.pdf" download>Download Resume</a>
